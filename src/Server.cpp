...
std::vector<std::string> const	&Server::getListen()
{
	return (this->_listen);
}
...
unsigned int	Server::getClientBSize()
{
...
std::map<unsigned short, std::string> Server::getErrorPageMap()
{
	return (this->_error_page);
}

std::vector<int> const		&Server::getFD()
{
	return (this->_fd);
}
